...
public class Messages {
    ...
    public static Object userMsgHelp(Long chatId) {
        String s = """
                ...
                Также вы можете оставить свой контакт, и мы свяжемся с вами лично.
                Кнопка ниже ↘️↘️↘️
                """;
    ...
    public static Object adminMsgHelp(Update update, Long logChat) {
        String s = ("""
                Пользователь {uid} ({cid}) нажал кнопку помощи.
                
                Ему доступна кнопка "Поделиться контактом" для личной консультации, но он её пока ещё не нажал.
                """)
